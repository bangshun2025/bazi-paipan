...
| 版本 | 日期 | 功能 | 关键文档 |
|------|------|------|----------|
| v0.30.0 | 09-11 | 星曜设置页迭代：设置页搜索筛选（IME 组合态闸门 / 命中计数 / 空提示 / ✕清空）+ ≥1280px 三栏同屏免滚动（单一 tbody 20/20/20 + 静态栏头）+ 共享表头几何与第 1 栏对齐 + 纳音列改完整纳音名（主盘零改动），断言 517→664 | [PRD](docs/PRD_v0.30.0_星曜设置页迭代.md)、[ADR](docs/ADR_v0.30.0_星曜设置页迭代.md)、[实施记录](docs/实施记录-v0.30.0-星曜设置页迭代.md)、[测试执行说明](docs/测试执行说明-v0.30.0.md)、[验收报告](docs/QA_v0.30.0_星曜设置页迭代.md) |
| v0.29.0 | 09-11 | 星曜功能：盘面「藏气」与「纳音」间新增用户自定义「星曜」行（L2 起显示）+ 工具栏「星曜」按钮/设置页（六十甲子×星曜名称/来源体系，四列 60 行，支持修改/清空/还原）+ `ALGORITHM.md` §21 幂等写入，断言 429→517 | [PRD](docs/PRD_v0.29.0_星曜功能.md)、[ADR](docs/ADR_v0.29.0_星曜功能.md)、[测试用例](docs/TEST_v0.29.0_星曜功能.md)、[验收报告](docs/QA_v0.29.0_星曜功能.md)、[部署报告](docs/部署报告-v0.29.0-内测发布.md) |
| v0.28.0 | 09-10 | 当年节气数据区干支行改为月建干支：每列最后一行「干支」由交节日柱改为该节月建干支（五虎遁直推；整块统一取所选干支年年基）；版式零变化、algorithm/constants 零改动，断言 393→429 | [PRD](docs/PRD_v0.28.0_干支行改月建干支.md)、[ADR](docs/ADR_v0.28.0_干支行改月建干支.md)、[验收报告](docs/report_v0.28.0_干支行改月建干支.md)、[部署报告](docs/部署报告-v0.28.0-内测发布.md) |
| v0.27.0 | 09-10 | 节气区真太阳日月/真太阳时间：每列在「时间」后、「节名」前新增两行（☀ 真太阳日月 M/D + ☀ 真太阳时间 HH:MM），BJT 交节经出生地经度换算；经度与 useSolar 解耦、无经度显「—」，断言 339→393 | [PRD](docs/PRD_v0.27.0_节气真太阳时.md)、[ADR](docs/ADR_v0.27.0_节气真太阳时.md)、[部署报告](docs/部署报告-v0.27.0-内测发布.md) |
| v0.26.0 | 09-07 | 当年节气数据（大运流年区下方 12 节，四行竖排：月日/时间/节名/干支，只节不气）+ 节气流年联动（默认出生年，点流年/大运/运前/📍今年跟随切换），断言 269→339 | [PRD](docs/PRD_v0.26.0_当年节气数据.md)、[PRD-v2](docs/PRD_v0.26.0_节气流年联动.md)、[ADR](docs/ADR_v0.26.0_当年节气数据.md)、[ADR-v2](docs/ADR_v0.26.0_节气流年联动.md)、[TEST](docs/TEST_v0.26.0_当年节气数据+节气流年联动.md)、[QA](docs/QA_v0.26.0_当年节气数据+节气流年联动验收报告.md) |
| v0.25.0 | 08-29 | 宫位配置保护：safeLoad/backupCorrupt 容错 + 导出/导入 JSON（schema 版本化）+ Supabase 云同步（AC10/AC11），断言 247→269 | [PRD](docs/PRD_v0.25.0_宫位配置保护.md)、[ADR](docs/ADR_v0.25.0_宫位配置保护.md)、[TEST](docs/TEST_v0.25.0_宫位配置保护.md)、[QA](docs/QA_v0.25.0_宫位配置保护验收报告.md) |
| v0.24.0 | 08-29 | Supabase 账号功能：Email+密码登录/30 天免登/云端排盘记录（保存/列表/查看/删除，RLS 用户隔离）/首次登录本地迁移 + P0-01 AI 录入守卫强化，断言 232→247 | [PRD](docs/PRD_v0.24.0_Supabase账号功能.md)、[ADR](docs/ADR_v0.24.0_Supabase账号功能.md)、[TEST](docs/TEST_v0.24.0_Supabase账号功能.md)、[QA](docs/QA_v0.24.0_P0-01修复回归报告.md) |
| v0.23.4 | 08-27 | 节气当天出生排盘崩溃修复：节气边界完整时刻比较 + 交运越界 null 防护（P0 崩溃根因），断言 224→232 | [PRD](docs/PRD_v0.23.1_节气当天出生崩溃修复.md)、[ADR](docs/ADR_v0.23.4_节气当天出生崩溃修复.md)、[QA](docs/QA_v0.23.4_节气当天出生崩溃修复.md)、[TEST](docs/TEST_v0.23.4_节气当天出生崩溃修复.md) |
| v0.23.3 | 08-23 | AI 录入识别农历/县份 + 农历模式排盘崩溃修复 | [TEST](docs/TEST_v0.23.1_节气当天出生崩溃修复.md) |
| v0.23.2 | 08-22 | 子时换日修复：真太阳时 23:00 后日柱取次日 | CHANGELOG |
| v0.23.1 | 08-22 | 农历+真太阳时排盘修复 | CHANGELOG |
