...
(function() {
  ...
  (function() {
    ...
    tests.push(eq('横排七项可勾', String(lvPop.querySelectorAll('.clp-item input[type=checkbox]').length), '7'));
    tests.push(eq('初始全不勾', String(lvPop.querySelectorAll('.clp-item input:checked').length), '0'));
    lvPop.querySelectorAll('.clp-item input')[3].click();
    ...
    C.setZoom(120);
    tests.push(eq('setZoom 后卡 style.zoom', document.querySelector('#cmpTrack .cmp-card').style.zoom, '120%'));
